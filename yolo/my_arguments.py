...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument("--epoch", type=int, default=50, help="number of end epoch")
        self.parser.add_argument("--start_epoch", type=int, default=0, help="number of start epoch")
        self.parser.add_argument("--use_GPU", action="store_true", help="identify whether to use gpu")  # 当包含该指令时为True
        self.parser.add_argument("--dataset_dir", type=str, default="./VOC2012/voc2012_forYolov1")
